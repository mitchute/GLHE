...
class TestFluid(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(tst_w.min_temperature, 0)
        self.assertEqual(tst_w.max_temperature, 200)
        ...
        self.assertEqual(tst_ea.min_temperature, -100)
        self.assertEqual(tst_ea.max_temperature, 40)
        self.assertEqual(tst_ea.min_concentration, 0)
        self.assertEqual(tst_ea.max_concentration, 60)
        ...
        self.assertEqual(tst_eg.min_temperature, -100)
        self.assertEqual(tst_eg.max_temperature, 100)
        self.assertEqual(tst_eg.min_concentration, 0)
        self.assertEqual(tst_eg.max_concentration, 60)
        ...
        self.assertEqual(tst_pg.min_temperature, -100)
        self.assertEqual(tst_pg.max_temperature, 100)
        self.assertEqual(tst_pg.min_concentration, 0)
        self.assertEqual(tst_pg.max_concentration, 60)
